module.exports = {
  ...
  Token: process.env.Token || "MTAwMzcyMDYxMTQwMDUzMTk4OQ.Gv-cbR.pY6BSh5cHSm__itAqIEnYB_IkCkLy0X_ixH6nE", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1003720611400531989", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "z5NM2kFGHhPlV4lqA51z_3aBlwyBFAav", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "1242322e4830446fb90823b2b5e59574", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "5fe87ac1edbd46548cd05b46915c6b3a", // Spotify Client Secret
  },
};
